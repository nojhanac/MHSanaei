...
// استفاده از Context برای مدیریت بهتر shutdown
func runWebServer() {
    ...
    // --- ارتقا 1: اضافه کردن SIGINT (Ctrl+C) برای خاموش شدن نرم ---
    ...
    for {
        ...
        case syscall.SIGHUP:
            ...
            err = subServer.Stop()
            if err != nil {
                logger.Error("Error stopping sub server:", err)
            }
        ...
        case syscall.SIGINT, syscall.SIGTERM:
            // مدیریت یکپارچه برای Ctrl+C و SIGTERM
...
// --- ارتقا 2: اعتبارسنجی پورت (Validation) ---
